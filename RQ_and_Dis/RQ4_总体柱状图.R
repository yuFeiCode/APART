...
get.SAT.result.only.for.actionable.warning = function(all_eval_releases, SAT.result.dir, SATname, line.ground.truth, lineLevelMetrics, save.fig.dir,IFA_y_limit, FPA_y_limit)
{
  ...
  sum_SAT_F.result.df = add_median_row(sum_SAT_F.result.df)
  
  
  SAT.median.release.df = sum_SAT.result.df[nrow(sum_SAT.result.df), -1]
  SAT_NT.median.release.df = sum_SAT_NT.result.df[nrow(sum_SAT_NT.result.df), -1]
  SAT_NFC.median.release.df = sum_SAT_NFC.result.df[nrow(sum_SAT_NFC.result.df), -1]
  SAT_F.median.release.df = sum_SAT_F.result.df[nrow(sum_SAT_F.result.df), -1]
  
  ALL.SAT.RQ4.median.result <<- rbind(ALL.SAT.RQ4.median.result, SAT.median.release.df)
  ALL.SAT_NT.RQ4.median.result <<- rbind(ALL.SAT_NT.RQ4.median.result, SAT_NT.median.release.df)
  ALL.SAT_NFC.RQ4.median.result <<- rbind(ALL.SAT_NFC.RQ4.median.result, SAT_NFC.median.release.df)
  ALL.SAT_F.RQ4.median.result <<- rbind(ALL.SAT_F.RQ4.median.result, SAT_F.median.release.df)
...
ALL.SAT_F.RQ4.median.result = NULL
...
write.csv(ALL.SAT_NT.RQ4.median.result, paste0(RQ4.save.fig.dir,'SAT_NT八个工具总体中位值.csv'))
write.csv(ALL.SAT_NFC.RQ4.median.result, paste0(RQ4.save.fig.dir,'SAT_NFC八个工具总体中位值.csv'))
write.csv(ALL.SAT_F.RQ4.median.result, paste0(RQ4.save.fig.dir,'SAT_F八个工具总体中位值.csv'))
