...
def write_json_config_to_env(config: Dict[Text, Any], get_first_best_key) -> None:
...
def load_json_config(get_first_best_key) -> Dict[Text, Any]:
    ...
    try:
        ...
        with open(current_path+'/config.json', 'r') as f:
            ...
            write_json_config_to_env(config, get_first_best_key)
